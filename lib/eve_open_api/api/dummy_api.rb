  ...
  class DummyApi
    ...
    def get_characters_character_id_wallets_journal_with_http_info(character_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: DummyApi.get_characters_character_id_wallets_journal ..."
      end
      # verify the required parameter 'character_id' is set
      fail ArgumentError, "Missing the required parameter 'character_id' when calling DummyApi.get_characters_character_id_wallets_journal" if character_id.nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DummyApi#get_characters_character_id_wallets_journal\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_characters_character_id_wallets_transactions_with_http_info(character_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: DummyApi.get_characters_character_id_wallets_transactions ..."
      end
      # verify the required parameter 'character_id' is set
      fail ArgumentError, "Missing the required parameter 'character_id' when calling DummyApi.get_characters_character_id_wallets_transactions" if character_id.nil?
      if opts[:'datasource'] && !['tranquility', 'singularity'].include?(opts[:'datasource'])
        fail ArgumentError, 'invalid value for "datasource", must be one of tranquility, singularity'
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DummyApi#get_characters_character_id_wallets_transactions\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_corporations_corporation_id_wallets_with_http_info(corporation_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: DummyApi.get_corporations_corporation_id_wallets ..."
      end
      # verify the required parameter 'corporation_id' is set
      fail ArgumentError, "Missing the required parameter 'corporation_id' when calling DummyApi.get_corporations_corporation_id_wallets" if corporation_id.nil?
      if opts[:'datasource'] && !['tranquility', 'singularity'].include?(opts[:'datasource'])
        fail ArgumentError, 'invalid value for "datasource", must be one of tranquility, singularity'
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DummyApi#get_corporations_corporation_id_wallets\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_corporations_corporation_id_wallets_wallet_id_journal_with_http_info(corporation_id, wallet_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: DummyApi.get_corporations_corporation_id_wallets_wallet_id_journal ..."
      end
      # verify the required parameter 'corporation_id' is set
      fail ArgumentError, "Missing the required parameter 'corporation_id' when calling DummyApi.get_corporations_corporation_id_wallets_wallet_id_journal" if corporation_id.nil?
      # verify the required parameter 'wallet_id' is set
      fail ArgumentError, "Missing the required parameter 'wallet_id' when calling DummyApi.get_corporations_corporation_id_wallets_wallet_id_journal" if wallet_id.nil?
      if opts[:'datasource'] && !['tranquility', 'singularity'].include?(opts[:'datasource'])
        fail ArgumentError, 'invalid value for "datasource", must be one of tranquility, singularity'
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DummyApi#get_corporations_corporation_id_wallets_wallet_id_journal\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_corporations_corporation_id_wallets_wallet_id_transactions_with_http_info(corporation_id, wallet_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: DummyApi.get_corporations_corporation_id_wallets_wallet_id_transactions ..."
      end
      # verify the required parameter 'corporation_id' is set
      fail ArgumentError, "Missing the required parameter 'corporation_id' when calling DummyApi.get_corporations_corporation_id_wallets_wallet_id_transactions" if corporation_id.nil?
      # verify the required parameter 'wallet_id' is set
      fail ArgumentError, "Missing the required parameter 'wallet_id' when calling DummyApi.get_corporations_corporation_id_wallets_wallet_id_transactions" if wallet_id.nil?
      if opts[:'datasource'] && !['tranquility', 'singularity'].include?(opts[:'datasource'])
        fail ArgumentError, 'invalid value for "datasource", must be one of tranquility, singularity'
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DummyApi#get_corporations_corporation_id_wallets_wallet_id_transactions\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_universe_planets_planet_id_with_http_info(planet_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: DummyApi.get_universe_planets_planet_id ..."
      end
      # verify the required parameter 'planet_id' is set
      fail ArgumentError, "Missing the required parameter 'planet_id' when calling DummyApi.get_universe_planets_planet_id" if planet_id.nil?
      if opts[:'datasource'] && !['tranquility', 'singularity'].include?(opts[:'datasource'])
        fail ArgumentError, 'invalid value for "datasource", must be one of tranquility, singularity'
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DummyApi#get_universe_planets_planet_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
