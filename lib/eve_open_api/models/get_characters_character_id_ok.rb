...
module EVEOpenAPI
  ...
  class GetCharactersCharacterIdOk
    ...
    def list_invalid_properties
      ...
      if !@security_status.nil? && @security_status > 10.0
        invalid_properties.push("invalid value for 'security_status', must be smaller than or equal to 10.0.")
      end

      if !@security_status.nil? && @security_status < -10.0
        invalid_properties.push("invalid value for 'security_status', must be greater than or equal to -10.0.")
      end
    ...
    def valid?
      return false if @ancestry_id.nil?
      ...
      return false if !@security_status.nil? && @security_status > 10.0
      return false if !@security_status.nil? && @security_status < -10.0
      return true
    end
    ...
    def security_status=(security_status)
      ...
      if !security_status.nil? && security_status > 10.0
        fail ArgumentError, "invalid value for 'security_status', must be smaller than or equal to 10.0."
      end

      if !security_status.nil? && security_status < -10.0
        fail ArgumentError, "invalid value for 'security_status', must be greater than or equal to -10.0."
      end
    ...
    def hash
      [ancestry_id, birthday, bloodline_id, corporation_id, description, gender, name, race_id, security_status].hash
    end
