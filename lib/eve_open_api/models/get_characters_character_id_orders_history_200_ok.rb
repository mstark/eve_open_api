...
module EVEOpenAPI
  ...
  class GetCharactersCharacterIdOrdersHistory200Ok
    ...
    def hash
      [order_id, type_id, region_id, location_id, range, price, volume_total, volume_remain, issued, is_buy_order, min_volume, escrow, duration, state, is_corporation].hash
    end
