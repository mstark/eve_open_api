...
module EVEOpenAPI
  ...
  class GetCorporationsCorporationIdStructures200Ok
    ...
    def hash
      [structure_id, type_id, corporation_id, system_id, profile_id, fuel_expires, services, state_timer_start, state_timer_end, unanchors_at, state, reinforce_weekday, reinforce_hour, next_reinforce_weekday, next_reinforce_hour, next_reinforce_apply].hash
    end
