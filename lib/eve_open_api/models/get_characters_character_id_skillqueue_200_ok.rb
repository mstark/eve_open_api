  ...
  class GetCharactersCharacterIdSkillqueue200Ok
    ...
    def list_invalid_properties
      ...
      if @finished_level > 5.0
        invalid_properties.push("invalid value for 'finished_level', must be smaller than or equal to 5.0.")
      end

      if @finished_level < 0.0
        invalid_properties.push("invalid value for 'finished_level', must be greater than or equal to 0.0.")
      end
    ...
    def valid?
      ...
      return false if @finished_level > 5.0
      return false if @finished_level < 0.0
    ...
    def finished_level=(finished_level)
      ...
      if finished_level > 5.0
        fail ArgumentError, "invalid value for 'finished_level', must be smaller than or equal to 5.0."
      end

      if finished_level < 0.0
        fail ArgumentError, "invalid value for 'finished_level', must be greater than or equal to 0.0."
      end
