...
module EVEOpenAPI
  ...
  class GetCorporationsCorporationIdContainersLogs200Ok
    ...
    def hash
      [logged_at, container_id, container_type_id, character_id, location_id, action, password_type, type_id, quantity, old_config_bitmask, new_config_bitmask, location_flag].hash
    end
