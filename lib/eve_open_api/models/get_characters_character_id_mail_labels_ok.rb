...
module EveOpenApi
  ...
  class GetCharactersCharacterIdMailLabelsOk
    ...
    def list_invalid_properties
      ...
      if !@total_unread_count.nil? && @total_unread_count < 0.0
        invalid_properties.push("invalid value for 'total_unread_count', must be greater than or equal to 0.0.")
      end
    ...
    def valid?
      return false if !@total_unread_count.nil? && @total_unread_count < 0.0
      return true
    end
    ...
    def total_unread_count=(total_unread_count)
      ...
      if !total_unread_count.nil? && total_unread_count < 0.0
        fail ArgumentError, "invalid value for 'total_unread_count', must be greater than or equal to 0.0."
      end
