...
# Unit tests for EVEOpenAPI::GetFleetsFleetIdMembers200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetFleetsFleetIdMembers200Ok' do
  before do
    # run before each test
    @instance = EVEOpenAPI::GetFleetsFleetIdMembers200Ok.new
  end
  ...
  describe 'test an instance of GetFleetsFleetIdMembers200Ok' do
    it 'should create an instance of GetFleetsFleetIdMembers200Ok' do
      expect(@instance).to be_instance_of(EVEOpenAPI::GetFleetsFleetIdMembers200Ok)
    end
  end
