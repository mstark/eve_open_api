...
# Unit tests for EVEOpenAPI::GetFwLeaderboardsCharactersYesterdayYesterday1
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetFwLeaderboardsCharactersYesterdayYesterday1' do
  before do
    # run before each test
    @instance = EVEOpenAPI::GetFwLeaderboardsCharactersYesterdayYesterday1.new
  end
  ...
  describe 'test an instance of GetFwLeaderboardsCharactersYesterdayYesterday1' do
    it 'should create an instance of GetFwLeaderboardsCharactersYesterdayYesterday1' do
      expect(@instance).to be_instance_of(EVEOpenAPI::GetFwLeaderboardsCharactersYesterdayYesterday1)
    end
  end
