...
# Unit tests for EVEOpenAPI::GetUniverseSystemJumps200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetUniverseSystemJumps200Ok' do
  before do
    # run before each test
    @instance = EVEOpenAPI::GetUniverseSystemJumps200Ok.new
  end
  ...
  describe 'test an instance of GetUniverseSystemJumps200Ok' do
    it 'should create an instance of GetUniverseSystemJumps200Ok' do
      expect(@instance).to be_instance_of(EVEOpenAPI::GetUniverseSystemJumps200Ok)
    end
  end
