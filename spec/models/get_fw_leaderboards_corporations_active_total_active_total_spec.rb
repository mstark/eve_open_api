...
# Unit tests for EVEOpenAPI::GetFwLeaderboardsCorporationsActiveTotalActiveTotal
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetFwLeaderboardsCorporationsActiveTotalActiveTotal' do
  before do
    # run before each test
    @instance = EVEOpenAPI::GetFwLeaderboardsCorporationsActiveTotalActiveTotal.new
  end
  ...
  describe 'test an instance of GetFwLeaderboardsCorporationsActiveTotalActiveTotal' do
    it 'should create an instance of GetFwLeaderboardsCorporationsActiveTotalActiveTotal' do
      expect(@instance).to be_instance_of(EVEOpenAPI::GetFwLeaderboardsCorporationsActiveTotalActiveTotal)
    end
  end
