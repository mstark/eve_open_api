...
# Unit tests for EVEOpenAPI::GetFwLeaderboardsCorporationsKills
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetFwLeaderboardsCorporationsKills' do
  before do
    # run before each test
    @instance = EVEOpenAPI::GetFwLeaderboardsCorporationsKills.new
  end
  ...
  describe 'test an instance of GetFwLeaderboardsCorporationsKills' do
    it 'should create an instance of GetFwLeaderboardsCorporationsKills' do
      expect(@instance).to be_instance_of(EVEOpenAPI::GetFwLeaderboardsCorporationsKills)
    end
  end
