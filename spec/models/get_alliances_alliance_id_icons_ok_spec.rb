...
# Unit tests for EVEOpenAPI::GetAlliancesAllianceIdIconsOk
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetAlliancesAllianceIdIconsOk' do
  before do
    # run before each test
    @instance = EVEOpenAPI::GetAlliancesAllianceIdIconsOk.new
  end
  ...
  describe 'test an instance of GetAlliancesAllianceIdIconsOk' do
    it 'should create an instance of GetAlliancesAllianceIdIconsOk' do
      expect(@instance).to be_instance_of(EVEOpenAPI::GetAlliancesAllianceIdIconsOk)
    end
  end
