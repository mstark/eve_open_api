...
# Unit tests for EVEOpenAPI::PostCharactersCharacterIdFittingsCreated
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PostCharactersCharacterIdFittingsCreated' do
  before do
    # run before each test
    @instance = EVEOpenAPI::PostCharactersCharacterIdFittingsCreated.new
  end
  ...
  describe 'test an instance of PostCharactersCharacterIdFittingsCreated' do
    it 'should create an instance of PostCharactersCharacterIdFittingsCreated' do
      expect(@instance).to be_instance_of(EVEOpenAPI::PostCharactersCharacterIdFittingsCreated)
    end
  end
