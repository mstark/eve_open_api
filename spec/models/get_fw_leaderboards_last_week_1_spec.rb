...
# Unit tests for EVEOpenAPI::GetFwLeaderboardsLastWeek1
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetFwLeaderboardsLastWeek1' do
  before do
    # run before each test
    @instance = EVEOpenAPI::GetFwLeaderboardsLastWeek1.new
  end
  ...
  describe 'test an instance of GetFwLeaderboardsLastWeek1' do
    it 'should create an instance of GetFwLeaderboardsLastWeek1' do
      expect(@instance).to be_instance_of(EVEOpenAPI::GetFwLeaderboardsLastWeek1)
    end
  end
