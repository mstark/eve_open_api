...
# Unit tests for EVEOpenAPI::GetWarsWarIdDefender
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetWarsWarIdDefender' do
  before do
    # run before each test
    @instance = EVEOpenAPI::GetWarsWarIdDefender.new
  end
  ...
  describe 'test an instance of GetWarsWarIdDefender' do
    it 'should create an instance of GetWarsWarIdDefender' do
      expect(@instance).to be_instance_of(EVEOpenAPI::GetWarsWarIdDefender)
    end
  end
