...
# Unit tests for EVEOpenAPI::GetUniverseTypesTypeIdDogmaEffect
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetUniverseTypesTypeIdDogmaEffect' do
  before do
    # run before each test
    @instance = EVEOpenAPI::GetUniverseTypesTypeIdDogmaEffect.new
  end
  ...
  describe 'test an instance of GetUniverseTypesTypeIdDogmaEffect' do
    it 'should create an instance of GetUniverseTypesTypeIdDogmaEffect' do
      expect(@instance).to be_instance_of(EVEOpenAPI::GetUniverseTypesTypeIdDogmaEffect)
    end
  end
