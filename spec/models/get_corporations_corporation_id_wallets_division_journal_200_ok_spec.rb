...
# Unit tests for EVEOpenAPI::GetCorporationsCorporationIdWalletsDivisionJournal200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCorporationsCorporationIdWalletsDivisionJournal200Ok' do
  before do
    # run before each test
    @instance = EVEOpenAPI::GetCorporationsCorporationIdWalletsDivisionJournal200Ok.new
  end
  ...
  describe 'test an instance of GetCorporationsCorporationIdWalletsDivisionJournal200Ok' do
    it 'should create an instance of GetCorporationsCorporationIdWalletsDivisionJournal200Ok' do
      expect(@instance).to be_instance_of(EVEOpenAPI::GetCorporationsCorporationIdWalletsDivisionJournal200Ok)
    end
  end
  ...
  describe 'test attribute "first_party_type"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["character", "corporation", "alliance", "faction", "system"])
       #validator.allowable_values.each do |value|
