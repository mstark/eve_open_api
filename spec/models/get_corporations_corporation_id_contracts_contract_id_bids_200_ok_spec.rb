...
# Unit tests for EVEOpenAPI::GetCorporationsCorporationIdContractsContractIdBids200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCorporationsCorporationIdContractsContractIdBids200Ok' do
  before do
    # run before each test
    @instance = EVEOpenAPI::GetCorporationsCorporationIdContractsContractIdBids200Ok.new
  end
  ...
  describe 'test an instance of GetCorporationsCorporationIdContractsContractIdBids200Ok' do
    it 'should create an instance of GetCorporationsCorporationIdContractsContractIdBids200Ok' do
      expect(@instance).to be_instance_of(EVEOpenAPI::GetCorporationsCorporationIdContractsContractIdBids200Ok)
    end
  end
