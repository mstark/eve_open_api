...
# Unit tests for EVEOpenAPI::GetCharactersCharacterIdClonesOk
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdClonesOk' do
  before do
    # run before each test
    @instance = EVEOpenAPI::GetCharactersCharacterIdClonesOk.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdClonesOk' do
    it 'should create an instance of GetCharactersCharacterIdClonesOk' do
      expect(@instance).to be_instance_of(EVEOpenAPI::GetCharactersCharacterIdClonesOk)
    end
  end
