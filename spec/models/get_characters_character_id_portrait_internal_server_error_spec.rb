...
# Unit tests for EveOpenApi::GetCharactersCharacterIdPortraitInternalServerError
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdPortraitInternalServerError' do
  before do
    # run before each test
    @instance = EveOpenApi::GetCharactersCharacterIdPortraitInternalServerError.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdPortraitInternalServerError' do
    it 'should create an instact of GetCharactersCharacterIdPortraitInternalServerError' do
      expect(@instance).to be_instance_of(EveOpenApi::GetCharactersCharacterIdPortraitInternalServerError)
    end
  end
