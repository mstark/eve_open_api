...
# Unit tests for EVEOpenAPI::PostCharactersCharacterIdMailRecipient
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PostCharactersCharacterIdMailRecipient' do
  before do
    # run before each test
    @instance = EVEOpenAPI::PostCharactersCharacterIdMailRecipient.new
  end
  ...
  describe 'test an instance of PostCharactersCharacterIdMailRecipient' do
    it 'should create an instance of PostCharactersCharacterIdMailRecipient' do
      expect(@instance).to be_instance_of(EVEOpenAPI::PostCharactersCharacterIdMailRecipient)
    end
  end
