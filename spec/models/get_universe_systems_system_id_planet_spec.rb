...
# Unit tests for EVEOpenAPI::GetUniverseSystemsSystemIdPlanet
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetUniverseSystemsSystemIdPlanet' do
  before do
    # run before each test
    @instance = EVEOpenAPI::GetUniverseSystemsSystemIdPlanet.new
  end
  ...
  describe 'test an instance of GetUniverseSystemsSystemIdPlanet' do
    it 'should create an instance of GetUniverseSystemsSystemIdPlanet' do
      expect(@instance).to be_instance_of(EVEOpenAPI::GetUniverseSystemsSystemIdPlanet)
    end
  end
