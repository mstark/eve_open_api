...
# Unit tests for EVEOpenAPI::GetFwLeaderboardsCharactersVictoryPoints
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetFwLeaderboardsCharactersVictoryPoints' do
  before do
    # run before each test
    @instance = EVEOpenAPI::GetFwLeaderboardsCharactersVictoryPoints.new
  end
  ...
  describe 'test an instance of GetFwLeaderboardsCharactersVictoryPoints' do
    it 'should create an instance of GetFwLeaderboardsCharactersVictoryPoints' do
      expect(@instance).to be_instance_of(EVEOpenAPI::GetFwLeaderboardsCharactersVictoryPoints)
    end
  end
