...
# Unit tests for EVEOpenAPI::GetFwLeaderboardsLastWeekLastWeek
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetFwLeaderboardsLastWeekLastWeek' do
  before do
    # run before each test
    @instance = EVEOpenAPI::GetFwLeaderboardsLastWeekLastWeek.new
  end
  ...
  describe 'test an instance of GetFwLeaderboardsLastWeekLastWeek' do
    it 'should create an instance of GetFwLeaderboardsLastWeekLastWeek' do
      expect(@instance).to be_instance_of(EVEOpenAPI::GetFwLeaderboardsLastWeekLastWeek)
    end
  end
