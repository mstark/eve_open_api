...
# Unit tests for EVEOpenAPI::GetCorporationsCorporationIdContainersLogs200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCorporationsCorporationIdContainersLogs200Ok' do
  before do
    # run before each test
    @instance = EVEOpenAPI::GetCorporationsCorporationIdContainersLogs200Ok.new
  end
  ...
  describe 'test an instance of GetCorporationsCorporationIdContainersLogs200Ok' do
    it 'should create an instance of GetCorporationsCorporationIdContainersLogs200Ok' do
      expect(@instance).to be_instance_of(EVEOpenAPI::GetCorporationsCorporationIdContainersLogs200Ok)
    end
  end
