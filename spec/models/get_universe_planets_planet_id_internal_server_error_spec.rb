...
# Unit tests for EveOpenApi::GetUniversePlanetsPlanetIdInternalServerError
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetUniversePlanetsPlanetIdInternalServerError' do
  before do
    # run before each test
    @instance = EveOpenApi::GetUniversePlanetsPlanetIdInternalServerError.new
  end
  ...
  describe 'test an instance of GetUniversePlanetsPlanetIdInternalServerError' do
    it 'should create an instact of GetUniversePlanetsPlanetIdInternalServerError' do
      expect(@instance).to be_instance_of(EveOpenApi::GetUniversePlanetsPlanetIdInternalServerError)
    end
  end
