...
# Unit tests for EVEOpenAPI::GetCharactersCharacterIdStatsOrbital
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdStatsOrbital' do
  before do
    # run before each test
    @instance = EVEOpenAPI::GetCharactersCharacterIdStatsOrbital.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdStatsOrbital' do
    it 'should create an instance of GetCharactersCharacterIdStatsOrbital' do
      expect(@instance).to be_instance_of(EVEOpenAPI::GetCharactersCharacterIdStatsOrbital)
    end
  end
