...
# Unit tests for EVEOpenAPI::GetCharactersCharacterIdCalendarEventIdAttendees200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdCalendarEventIdAttendees200Ok' do
  before do
    # run before each test
    @instance = EVEOpenAPI::GetCharactersCharacterIdCalendarEventIdAttendees200Ok.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdCalendarEventIdAttendees200Ok' do
    it 'should create an instance of GetCharactersCharacterIdCalendarEventIdAttendees200Ok' do
      expect(@instance).to be_instance_of(EVEOpenAPI::GetCharactersCharacterIdCalendarEventIdAttendees200Ok)
    end
  end
