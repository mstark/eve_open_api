...
# Unit tests for EVEOpenAPI::GetDogmaDynamicItemsTypeIdItemIdDogmaEffect
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetDogmaDynamicItemsTypeIdItemIdDogmaEffect' do
  before do
    # run before each test
    @instance = EVEOpenAPI::GetDogmaDynamicItemsTypeIdItemIdDogmaEffect.new
  end
  ...
  describe 'test an instance of GetDogmaDynamicItemsTypeIdItemIdDogmaEffect' do
    it 'should create an instance of GetDogmaDynamicItemsTypeIdItemIdDogmaEffect' do
      expect(@instance).to be_instance_of(EVEOpenAPI::GetDogmaDynamicItemsTypeIdItemIdDogmaEffect)
    end
  end
