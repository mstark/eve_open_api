...
# Unit tests for EVEOpenAPI::GetCharactersCharacterIdWalletsJournal200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdWalletsJournal200Ok' do
  before do
    # run before each test
    @instance = EVEOpenAPI::GetCharactersCharacterIdWalletsJournal200Ok.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdWalletsJournal200Ok' do
    it 'should create an instact of GetCharactersCharacterIdWalletsJournal200Ok' do
      expect(@instance).to be_instance_of(EVEOpenAPI::GetCharactersCharacterIdWalletsJournal200Ok)
    end
  end
  ...
  describe 'test attribute "post_transaction_balance"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
